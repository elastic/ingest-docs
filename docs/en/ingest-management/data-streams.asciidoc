...
. For a newly added integration the component template won't exist yet. Select **Create component template** to create it.
...
This tutorial explains how to apply a custom index lifecycle policy to the `system-auth` data stream.
