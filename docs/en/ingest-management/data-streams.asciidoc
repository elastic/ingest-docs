...
[[data-streams-experimental-features]]
== Enabling and disabling experimental indexing features for {fleet}-managed data streams

++++
<titleabbrev>Experimental data stream features</titleabbrev>
++++
...
Refer to the following steps to enable or disable experimental data stream features:

* <<data-streams-experimental-synthetic-enable>>
* <<data-streams-experimental-synthetic-disable>>
* <<data-streams-experimental-tsds-enable>>
* <<data-streams-experimental-tsds-disable>>
...
To disable TSDS, follow the same procedure as to <<data-streams-experimental-tsds-enable,enable TSDS>>, but specify `null` for `index.mode` instead of `time_series`.
