...
By default, {agent} initializes the `add_host_metadata` processor with the `netinfo.enabled` parameter enabled. This parameter includes IP addresses and MAC addresses as fields `host.ip` and `host.mac`. 
