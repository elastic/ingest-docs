...
By default, {agent} initialises the add_host_metadata processor with netinfo.enabled parameter enabled. This parameter includes IP addresses and MAC addresses as fields host.ip and host.mac. 
