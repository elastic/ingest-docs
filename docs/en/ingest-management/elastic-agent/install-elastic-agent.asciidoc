...
During upgrades, double the disk space will be required to store new {agent} binary. Once upgraded the original {agent} is removed from disk to free up the space.  
