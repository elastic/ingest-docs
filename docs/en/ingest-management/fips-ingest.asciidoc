...
- link:https://www.elastic.co/docs/reference/integrations/azure_functions[Azure Functions]
- link:https://www.elastic.co/docs/reference/integrations/azure_logs[Custom Azure Logs]
