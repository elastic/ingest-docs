...
This page describes how to configure proxy settings for {agent} managed by {fleet}.
...
**image TBD**
+
.. In the **Add Proxy** flyout, add a name (in this example `Proxy-A`) and specify the Proxy URL.
