...
perofming agent installations, version upgrades, policy modifications, adding/removing integrations, 
tags and policies. An acceptance criteria is passed when the {agent}s reach a Healthy state after any
of these operations.
