...
The following table explains the various possible upgrade states. States are listed in the order that they happen.
...
As well, for {agents} on version 8.12 and higher, you can hover your cursor over the information icon to get more granular details about the upgrade state.
