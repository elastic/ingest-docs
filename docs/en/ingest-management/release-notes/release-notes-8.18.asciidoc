...
{agent}::
* Update Go version to v1.24.3 {elastic-agent-pull}https://github.com/elastic/elastic-agent/pull/8109[#8109]

{fleet}::
* Update Go version to v1.24.3 {fleet-server-pull}https://github.com/elastic/fleet-server/pull/4891[#4891]
