...
[[release-notes-8.19.21-build202609151720]]
== {fleet} and {agent} 8.19.21+build202609151720
...
* Add workaround to macOS {elastic-defend} for Golden Gate bug breaking network connections from apps using Network.framework. https://developer.apple.com/forums/thread/837709[Apple Developer Forums]
