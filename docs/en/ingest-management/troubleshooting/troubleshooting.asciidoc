...
In this example, we are upgrading the agent with agent-id *5f18484c-17d5-12fe-c455-fcde50f8b* to version *8.7.0*. The dev tools can be found by browsing to Management -> Dev Tools of your instance. The agent-id of an Agent can be found by browsing to Management -> Fleet -> Search for the Agent based, for example, hostname.
